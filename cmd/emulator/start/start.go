...
type Config struct {
	...
	TransactionValidationEnabled bool          `default:"true" flag:"transaction-validation" info:"enable transaction validation"`
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			serverConf := &server.Config{
				...
				TransactionValidationEnabled: conf.TransactionValidationEnabled,
